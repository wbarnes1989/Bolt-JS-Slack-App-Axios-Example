...
How you host your app is up to you, locally via ngrok, remotely via Heroku, your choice. You'll need to provide your Slack App with the URL for your app, wherever it is hosted. Remember to setup your environment variables and keep in mind that bolt listens for events on `/slack/events`. For instance, this is the Forwarding URL when working with ngrok. So your Events Request URL for your Slack App would be: `https://{ngrok-forwarding-URL}/slack/events`
